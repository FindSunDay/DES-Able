...
for year in range(2011, 2021):
    ...
    for month in range(1, 13):
        ...
        # old template
            ...
            df = pd.read_excel("../Dataset/original_dataset/DES_monthly_reports/DES_" + str(month) + "_" + str(year) + ".xlsx", \
...
# save to csv
data.to_csv('../Dataset/wrangled_dataset/DES_PERFORMANCE_NUMERICAL.csv', index=False)
...
data.to_csv('../Dataset/wrangled_dataset/DES_PERFORMANCE.csv', index=False)